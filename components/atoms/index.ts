...
export { default as KeyIcon, KeyIcon1 } from './icons/key'
...
export { default as SalesVolume } from './icons/sales_volume'
...
export { default as Configuration } from './icons/configuration'
