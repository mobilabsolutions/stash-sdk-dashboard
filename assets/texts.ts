export default {
  ...
  GOOGLE_PAY: { en: 'GOOGLE PAY', de: 'GOOGLE PAY' },
  SEPA: {},
  KLARNA: {},
  CC: { en: 'Credit Card', de: 'Kreditkarte' },
  VISA: {},
  DK: {},
  DINERS: {},
  AMERICANEXPRESS: { en: 'AMERICAN EXPRESS', de: 'AMERICAN EXPRESS' },
  AMEX: {},
  CARTEBLEUE: {},
  DINERCLUB: {},
  DISCOVER: {},
  ...
  UNIONPAY: {},
  APPLE_PAY: { en: 'APPLE PAY', de: 'APPLE PAY' },
  reverse: { en: 'Reverse' },
  ...
  Filters: {},
  'Payment Method': {},
  'Used Payment Methods': { de: 'Verwendete Zahlungsmethoden' },
  Refunds: { de: 'Rückerstattungen' },
  Search: {},
  'Clear Filters': {},
  ...
  SUCCESS: { en: 'Success' },
  'SUCCESS-ADJ': { en: 'Successful' },
  FAIL: { en: 'Fail' },
  'FAIL-ADJ': { en: 'Failed' },
  PENDING: { en: 'Pending' },
  'PENDING-ADJ': { en: 'Pending' },
  ...
  'Upload  a new file': { de: 'Header-Logo hochladen' },
  Logo: { de: 'Logo' },
  ...
  'New Report': { de: 'Erstellen Sie einen neuen Bericht' },
